...
""" QSVDD Model that follow the paper implementations. """
...
def quantum_circuit(inputs, weights, n_qubits, num_params_conv, latent_dim):
    ...
    conv_layer_1(weights[0:num_params_conv])
    conv_layer_1(weights[num_params_conv: 2 * num_params_conv])
    conv_layer_2(weights[2 * num_params_conv: 3 * num_params_conv])
    conv_layer_2(weights[3 * num_params_conv: 4 * num_params_conv])
    conv_layer_3(weights[4 * num_params_conv: 5 * num_params_conv])
